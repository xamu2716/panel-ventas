...
/**
 * Costo unitario derivado del lote completo: lo pagado en Alibaba + flete +
 * publicidad del lote, repartido entre las unidades del lote. La publicidad
 * queda prorrateada aquí para no contarla dos veces junto con el módulo de
 * gastos de publicidad (que es solo para publicidad EXTRA no ligada a un lote).
 */
